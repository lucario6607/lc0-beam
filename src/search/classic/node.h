...
class Node {
 public:
  ...
  lczero::Value GetValue() const; // Use lczero::
  ...
  typedef std::pair<lczero::GameResult, lczero::GameResult> Bounds; // Use lczero::
  Bounds GetBounds() const { return {lower_bound_, upper_bound_}; }
  void SetBounds(lczero::GameResult lower, lczero::GameResult upper); // Use lczero::
  void MakeTerminal(lczero::GameResult result, float plies_left = 0.0f, // Use lczero::
  ...
  void FinalizeScoreUpdate(lczero::Value v, float d, float m, int multivisit); // Use lczero::
  void AdjustForTerminal(lczero::Value v_delta, float d_delta, float m_delta, int multivisit); // Use lczero::
  void RevertTerminalVisits(lczero::Value v, float d, float m, int multivisit); // Use lczero::
